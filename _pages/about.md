...
<div class="llm-terminal" role="region" aria-label="LLM terminal introduction">
  ...
  <!-- line 3: normal -->
  <div class="type-line" style="--n:11; --dur:calc(var(--n)*0.035s); --delay:5.85s;">
    June 2026.
  </div>
  ...
  <!-- line 5: normal -->
  <div class="type-line" style="--n:31; --dur:calc(var(--n)*0.035s); --delay:9.07s;">
  ...
  <!-- line 7: +2s -->
  <div class="type-line" style="--n:27; --dur:calc(var(--n)*0.035s); --delay:12.08s;">
    - 🤖 <strong>AI & LLM for Building</strong>
  </div>

  <!-- line 8: normal -->
  <div class="type-line" style="--n:32; --dur:calc(var(--n)*0.035s); --delay:13.02s;">
    - ⚙️ <strong>Physics-Informed Modeling</strong>
  </div>

  <!-- line 9: normal -->
  <div class="type-line" style="--n:58; --dur:calc(var(--n)*0.035s); --delay:14.14s;">
    - 🏙 <strong>(Urban) Building Energy Modeling & Calibration</strong>.
  </div>

  <!-- line 10: +2s -->
  <div class="type-line" style="--n:88; --dur:calc(var(--n)*0.035s); --delay:16.16s;">
    📌 I'm currently developing <strong>auto-building energy modeling (ABEM) using large language</strong>
  </div>

  <!-- line 11: normal -->
  <div class="type-line" style="--n:71; --dur:calc(var(--n)*0.035s); --delay:19.24s;">
